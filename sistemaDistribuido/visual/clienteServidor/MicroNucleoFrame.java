 ...
 * Practica 5 
 * Agrega Boton hacia servidor de Nombres y su action listener
 */
public class MicroNucleoFrame extends Frame implements WindowListener, Escribano, ParMaquinaProceso {
    ...
    public MicroNucleoFrame() {
        ...
        conector = new ServidorNombres(this);
    ...
    void cerrarFrameConector() {
        conector.setVisible(false);
        panelBotones.dameBotonServidorNombres().setEnabled(true);
    }
    ...
    class ManejadorBotones implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (com.equals("Cliente Erick")) {
                levantarProcesoFrame(new ClienteFrame(MicroNucleoFrame.this));
            } else if (com.equals("Servidor Erick")) {
