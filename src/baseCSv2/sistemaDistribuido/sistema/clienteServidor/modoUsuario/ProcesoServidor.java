package baseCSv2.sistemaDistribuido.sistema.clienteServidor.modoUsuario;


import baseCSv2.sistemaDistribuido.sistema.clienteServidor.modoMonitor.ConectorDNS;
import baseCSv2.sistemaDistribuido.sistema.rpc.modoUsuario.Datos;
...
public class ProcesoServidor extends Proceso{
    ...
    public void run(){
            ...
            idUnico = ConectorDNS.exportarInterfaz("Server", "1.0", asa);
